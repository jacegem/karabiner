...
;;    :cap_lock->ctrl+opt {:rule-type :raw
;;                         :description "caps_lock ➡️ left_control + left_option # :cap_lock->ctrl+opt",
;;                         :manipulators [{:type "basic",
;;                                         :from {:key_code "caps_lock",
;;                                                :modifiers {:optional ["any"]}},
;;                                         :to [{:set_variable {:name "ctrl+opt",
;;                                                              :value 1}}

;;                                              {:key_code "left_control",
;;                                               :modifiers ["left_option"]}]
;;                                         :to_after_key_up [{:set_variable {:name "ctrl+opt"
;;                                                                           :value 0}}]
;;                                         #_#_:to_if_alone [{:key_code "escape"}]
;;                                         #_#_:to_delayed_action {:to_if_invoked [{:set_variable {:name "ctrl+opt"
;;                                                                                                 :value 0}}]
;;                                                                 :to_if_canceled [{:set_variable {:name "ctrl+opt"
;;                                                                                                  :value 0}}]}}]}
...
;; ;;    :sd+space     {:rule-type :raw
;; ;;                   :description "sd + Space -> ctrl + opt + Shift",
;; ;;                   :manipulators [{:conditions [{:name "capslock-mode",
;; ;;                                                 :type "variable_if",
;; ;;                                                 :value 1}],
...
;;    :space {:rule-type :raw
;;            :description "ctrl + opt + Space -> Shift",
;;            :manipulators [{:type "basic",
;;                            :conditions [{:name "ctrl+opt",
;;                                          :type "variable_if",
;;                                          :value 1}],
;;                            :from {:key_code "spacebar",
;;                                   :modifiers {:optional [:any]}},
